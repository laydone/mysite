...
;layui.define(["index", "layim"], function(e) {
    ...
    t.on("sendMessage", function(e) {
        var a = e.to;
        "friend" === a.type && t.setChatStatus('<span style="color:#FF5722;">对方正在输入。。。</span>'),
        setTimeout(function() {
            var e = {};
            "group" === a.type ? e = {
            ...
            t.setChatStatus('<span style="color:#FF5722;">在线</span>')),
            t.getMessage(e)
        }, 1e3)
    }),
    ...
    var a = layui.jquery
      , i = {
        ...
        setGray: function() {
            t.setFriendStatus(168168, "offline"),
            layer.msg("已成功将好友[马小云]置灰", {
                icon: 1
            })
        },
        unGray: function() {
            t.setFriendStatus(168168, "online"),
